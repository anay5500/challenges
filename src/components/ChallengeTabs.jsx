...
function Tab({ isSelected, onSelect, badgeCaption, children }) {  //badegeCaption is the no. of challenges in a tab
  return (                                                        //children is the content in a particular tab
    <li>
      <button
